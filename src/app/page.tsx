    ...
    <section className="mb-16">
      ...
      {services.length > 0 ? (
        ...
        <div className="text-center py-20 bg-card rounded-xl">
          <h3 className="text-2xl font-semibold mb-2 font-headline">No services found</h3>
          <p className="text-muted-foreground">Try a different search term or check out our featured services.</p>
        </div>
      )}
    </section>
  );
