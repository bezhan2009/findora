...
export default function HorizontalServiceCard({ service }: HorizontalServiceCardProps) {
  ...
  return (
    <Card className="overflow-hidden h-full flex flex-row transition-all duration-300 hover:shadow-xl hover:border-primary/50 group">
      <Link href={`/services/${service.id}`} className="relative w-1/3 block">
          <Image
