        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                Политика возврата средств обычно устанавливается индивидуальными исполнителями. Мы рекомендуем обсуждать условия оплаты и возврата напрямую с исполнителем перед покупкой услуги. Findora предоставляет платформу для связи, но не обрабатывает прямые платежи или возвраты.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </CardContent>
