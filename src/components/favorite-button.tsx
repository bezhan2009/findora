...
export function FavoriteButton({ service, className, as = 'icon' }: FavoriteButtonProps) {
  ...
  const svgContent = (
    <svg
      ref={svgRef}
      className={cn('heart', favorited && 'text-rose-500', as === 'button' ? 'h-6 w-6 mr-2' : 'h-8 w-8')}
      viewBox="0 0 40 40"
      fill="none"
    >
      ...
      <g className="heart__beat">
          ...
          <path d="M22.685 34.029a2.585 2.585 0 00.975-3.61 2.585 2.585 0 00-3.609-.974 2.585 2.585 0 00-.975 3.608 2.585 2.585 0 003.609.976z" class="heart__segment heart__segment--end"/>
          <path d="M21.368 34.712a2.585 2.585 0 001.17-3.512 2.585 2.585 0 00-3.511-1.17 2.585 2.585 0 00-1.17 3.511 2.585 2.585 0 003.56 1.17z" class="heart__segment heart__segment--end"/>
